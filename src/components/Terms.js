  ...
  const tos = (
    ...
    >
      ...
      <p>
        ...
        Water my plants's Website. Water my plants is located at:
      </p>
      <address></address>
      <p>
        By accessing this website we assume you accept these terms of service in
        full. Do not continue to use Water my plants's website if you do not
      ...
      <h2>Cookies</h2>
      <p>
        We employ the use of cookies. By using Water my plants's website you
        consent to the use of cookies in accordance with Water my plants's
        privacy policy.
      </p>
      <p>
      ...
      <p>
        Redistribute content from Water my plants (unless content is
      ...
      <p>
        ...
        Water my plants; and (d) where the link is in the context of general
      ...
      <p>
        No use of Water my plants's logo or other artwork will be allowed for
